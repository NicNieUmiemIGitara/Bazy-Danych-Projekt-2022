...
public class TeacherDayOfTheWeek implements Serializable {
    ...
    public int setDay(Connection connection, int dayId, int teacher_id, Date date1, Date date2) throws SQLException {
