...
public class TeacherTestsPerDay implements Serializable {
    ...
    public int setDay(Connection connection, int dayId, int teacherId, Date date1, Date date2) throws SQLException {
